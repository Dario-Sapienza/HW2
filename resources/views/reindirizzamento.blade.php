...
<head>
    ...
    <link rel="stylesheet" href='{{url("./css/reindirizzamento.css")}}'>  
...
<section>
    <h1>PER POTER PRENOTARE UN CORSO DEVI PRIMA AVER EFFETTUATO L'ACCESSO !!</h1>
    <a href = '{{route("accesso")}}'>Accedi</a>
    <a class='home_page'  href = '{{route("homepage")}}'>Home page</a>
</section>
